...
namespace JETMASHRADIO.TextureModder
{
    public class Textures
    {
        ...
        public Textures()
        {
            ...
            StageTextures.Add(new StageTexture(JSR.Stage.BantamStreet, "st5txr.bin", 199));
            StageTextures.Add(new StageTexture(JSR.Stage.Garage, "GARAGE_DISPTXR.BIN", 6));
        }
    }
}
